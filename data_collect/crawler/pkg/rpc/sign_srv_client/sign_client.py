...
from data_collect.crawler.pkg.rpc.sign_srv_client.sign_model import (BilibliSignRequest,
                                                BilibliSignResponse,
                                                DouyinSignRequest,
                                                DouyinSignResponse,
                                                XhsSignRequest,
...
def _sign_server_url() -> str:
    return f"http://{config.SIGN_SRV_HOST}:{config.SIGN_SRV_PORT}"


SIGN_SERVER_URL = _sign_server_url()
...
class SignServerClient:
    def __init__(self, endpoint: str | None = None, timeout: int = 60):
        ...
        """
        self._endpoint = endpoint or _sign_server_url()
