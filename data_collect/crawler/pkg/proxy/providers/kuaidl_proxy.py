...
from data_collect.crawler.pkg.proxy import IpCache, IpInfoModel, ProxyProvider
from data_collect.crawler.pkg.proxy.types import ProviderNameEnum
...
def new_kuai_daili_proxy() -> KuaiDaiLiProxy:
    ...
    return KuaiDaiLiProxy(
        kdl_secret_id=config.KDL_SECRET_ID,
