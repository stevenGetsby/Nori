...
Nori 的当前权威项目文档在 `wiki/`。根 README 只做导航，避免和 wiki、历史归档文档重复维护。
...
| 改产品后端 / API | [backend/README.md](backend/README.md) |
| 改产品前端 / Workbench | [web/README.md](web/README.md) |
...
历史设计记录、Agent 分册和旧项目专用 Codex skill 已归档到 `wiki/archive/legacy-docs/`。旧进度记录在 `wiki/archive/进度.md`。后续新增或更新的项目级事实应写入 `wiki/`。
