...
from nori.ops_models.account_ops import ContentTask as DirectContentTask
...
def test_ops_models_are_exported_from_package():
    assert ContentTask is DirectContentTask
    assert ContentTask.__module__ == "nori.ops_models.account_ops"
    assert KPIPlan.__module__ == "nori.ops_models.account_ops"
    assert ContentPackage.__module__ == "nori.ops_models.account_ops"
    assert ComplianceReview.__module__ == "nori.ops_models.account_ops"
    assert MetricsSnapshot.__module__ == "nori.ops_models.account_ops"
    assert StrategyIteration.__module__ == "nori.ops_models.account_ops"
