...
from nori.ops_agents import CalendarPlannerAgent, plan_calendar
...
calendar_module = importlib.import_module("nori.ops_agents.calendar_planner")
...
def test_calendar_planner_uses_llm_json_when_available(monkeypatch):
    ...
    monkeypatch.setattr(calendar_module.llms, "chat", fake_chat)
