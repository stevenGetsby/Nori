...
from nori.ops_agents import KPIPlannerAgent, plan_kpi
from nori.ops_models import AccountOperationProject, ClientBrief, ContentTask, KPIPlan, OperationPlan


kpi_module = importlib.import_module("nori.ops_agents.kpi_planner")
...
def test_kpi_planner_uses_llm_json_when_available(monkeypatch):
    ...
    monkeypatch.setattr(kpi_module.llms, "chat", fake_chat)
