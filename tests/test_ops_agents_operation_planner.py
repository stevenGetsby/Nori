...
from nori.ops_agents import OperationPlannerAgent, plan_operation
from nori.ops_models import AccountOperationProject, ClientBrief


planner_module = importlib.import_module("nori.ops_agents.operation_planner")
...
def test_operation_planner_uses_llm_json_when_available(monkeypatch):
    ...
    monkeypatch.setattr(planner_module.llms, "chat", fake_chat)
