...
def build_content_generation_router(service: ContentGenerationRouteServiceProtocol) -> APIRouter:
    ...
    def content_options() -> dict[str, Any]:
        return api_ok(service.catalog_service.content_options())
    ...
    def content_option_group(group_id: str) -> dict[str, Any]:
        return api_ok(service.catalog_service.content_option_group(group_id))

    @router.get("/content/generation/actions", summary="List content generation sub-capabilities")
    def content_actions() -> dict[str, Any]:
        return api_ok(service.catalog_service.content_actions())
    ...
    def content_action(action_id: str) -> dict[str, Any]:
        return api_ok(service.catalog_service.content_action(action_id))
    ...
    def plan_content_generation(request: ContentGenerationPlanRequest) -> dict[str, Any]:
        return api_ok(service.catalog_service.plan_content_generation(request))
