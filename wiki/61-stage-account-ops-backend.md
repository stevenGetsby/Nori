...
| Module | Status | Notes |
| --- | --- | --- |
| `nori/context_building/models.py` | Implemented | Provider-free account-operation dataclasses with serialization; `from_dict()` input cleanup uses shared `nori._model_coercion` helpers. |
