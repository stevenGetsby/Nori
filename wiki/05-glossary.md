...
| ContentCalendar | Scheduled content themes and `ContentTask` list. | `nori/core/models.py` |
| ContentTask | One planned content unit that should later bridge into content generation. | `nori/core/models.py` |
...
| AssetRecord | One client/source/generated asset reference with usage, status, tags, source, and metadata. | `nori/core/models.py` |
| AssetLibrary | Typed project-level index for client/source/generated assets. | `nori/core/models.py` |
